# -*- coding: utf-8 -*-
#
# marshallEngine documentation build configuration file, created by
...
html_help_basename = 'marshallEnginedoc'
...
man_pages = [
    ('index', 'marshallEngine', u'marshallEngine Documentation',
     [u'Dave Young'], 1)
]
...
texinfo_documents = [
    ('index', 'marshallEngine', u'marshallEngine Documentation',
     u'Dave Young', 'marshallEngine', 'The engine behind the marshall webapp',
     'Miscellaneous'),
]
