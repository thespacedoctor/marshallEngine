...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.colors',
                'matplotlib.pyplot', 'matplotlib.cm', 'matplotlib.path', 'matplotlib.patches', 'matplotlib.projections', 'matplotlib.projections.geo', 'healpy', 'astropy', 'astropy.io', 'pylibmc', 'HMpTy', 'HMpTy.mysql', 'ligo', 'ligo.gracedb', 'ligo.gracedb.rest', 'pandas', 'astropy.coordinates', 'matplotlib.ticker', 'matplotlib.backends.backend_pdf', 'numpy.polynomial.chebyshev']
...
html_theme_options = {
    ...
    'github_repo': 'marshallEngine',
    'strap_line': "the engine behind the marshall webapp"
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/marshallEngine/tree/master"

# General information about the project.
now = datetime.now()
now = now.strftime("%Y")
project = u'marshallEngine'
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/marshallEngine.rst']
modindex_common_prefix = ["marshallEngine."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'marshallEngine.tex', u'marshallEngine Documentation',
     u'Dave Young', 'manual'),
]
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["marshallEngine"]
    allSubpackages += findAllSubpackges(
        pathToPackage="marshallEngine"
    )
