...
DELETE FROM `transientbucket` WHERE observationMjd is null and dateCreated < DATE_SUB(curdate(), INTERVAL 10 minute);
...
-- Dump completed on 2021-04-30  9:27:55
-- MySQL dump 10.17  Distrib 10.3.25-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: 10.131.21.162    Database: marshall
-- ------------------------------------------------------
...
INSERT INTO `meta_workflow_lists_counts` VALUES (1,'archive',128867),(2,'following',35),(3,'followup complete',712),(4,'review for followup',229),(5,'pending observation',31),(6,'inbox',394),(7,'external alert released',7496),(8,'pending classification',0),(9,'pessto classification released',1119),(10,'archived without alert',18743),(11,'queued for atel',0),(17,'classified',15063),(19,'all',130268),(20,'snoozed',35938);
