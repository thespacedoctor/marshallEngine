...
def generate_atlas_lightcurves(
    ...
    **Key Arguments**
    ...
    sqlQuery = u"""
        SELECT
            ...
            WHERE
                ...
                and t.dateCreated > NOW() -  INTERVAL 60 DAY
    ...
    if total > 5000:
        print("ATLAS lightcurves need generated for %(total)s sources - generating next 5000" % locals())
        transientIds = transientIds[:5000]
        total = len(transientIds)
    else:
